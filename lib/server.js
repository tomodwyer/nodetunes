...
function NodeTunes(opts) {
  ...
  // eslint-ignore
  if (options.verbose) {
    require("debug").enable("nodetunes:*"); // eslint-disable-line global-require
    // HACK below: need to reload debug here (https://github.com/visionmedia/debug/issues/150)
    debug = require("debug")("nodetunes:server"); // eslint-disable-line global-require
  }
